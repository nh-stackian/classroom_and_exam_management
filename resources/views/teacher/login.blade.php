...
<div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-img"> 
                    ...
                    <h3 class="text-center m-t-10 text-white"> Teacher <strong>Log In</strong> </h3>
                </div> 


                <div class="panel-body">
                <form class="form-horizontal m-t-20" method="POST" action="{{ route('teacher.login') }}">
                    @csrf
                    ...
                    <div class="form-group text-center m-t-40">
                        ...
                        @if (Route::has('password.request'))
                                    <a class="btn btn-danger" style="margin-top:10px;" href="{{ route('teacher.password.request') }}">
